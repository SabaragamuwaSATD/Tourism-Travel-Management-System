<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% 	
    	...
    	/*	int count = 0;
    		count = (int)session.getAttribute("countRes");
    		
    		System.out.println("jsp - " + count);*/
    	}
    %>
...
<body>
    ...
    <section class="home-banner-area" id="home">
        ...
        <div class="text-center">
            ...
            <h1><em>Dining</em></h1>
            <a class="button home-banner-btn" href="#form">Book Now</a><br><br>
            <a class="button home-banner-btn" href="#menu">View Menu</a><br><br>
      	</div>
        </div>
      	</div>
    </section>
			...
			<table class="table table-dark">
			  ...
			  <% Item itm = (Item)itemRes.get(i); %>
			    <tr>			      
			      ...
			      <td>Rs.<%= itm.getRegular() %></td>
			      <td>Rs.<%= itm.getLarge() %></td>			      
			    </tr>
			    <%}}%>
